 ...
 *         &lt;element name="places" type="{http://soap.api/}carPlace" maxOccurs="unbounded" minOccurs="0"/>
...
public class Zone {
    ...
    protected List<CarPlace> places;
    @XmlElement(nillable = true)
     ...
     * 
     */
    public List<CarPlace> getPlaces() {
        if (places == null) {
            places = new ArrayList<CarPlace>();
        }
        return this.places;
    }
